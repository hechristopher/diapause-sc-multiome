...
# all aggregated rimd1
filtered_path <- "../rimd1/filtered_feature_bc_matrix.h5"
raw_path <- "../rimd1/raw_feature_bc_matrix.h5"
fragments_path <- "../rimd1/atac_fragments.tsv.gz"
annotation_path <- "../rimd1/GCF_043380555.1_NfurGRZ-RIMD1_genomic_edited.gtf"

outs_dir <- "../results_rimd1/"
fig_path <- "../results_rimd1/figures/"
