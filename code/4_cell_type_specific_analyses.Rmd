...
SaveFigure(p, "heatmap_diaup_pseudo", height = 10, width = 10)
...
SaveFigure(p, "heatmap_diaup", height = 10, width = 10)
...
SaveFigure(ht, "cell_typte_motif_enrich", height = 40, width = 30)
