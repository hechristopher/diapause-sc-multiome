...
top_go_terms <- head(significant_go_data, 10)

ggplot(top_go_terms, aes(x = reorder(GO.molecular.function.complete, upload_1..fold.Enrichment.), y = upload_1..fold.Enrichment.)) +
  geom_bar(stat = "identity", fill = "steelblue") +
  coord_flip() +
  labs(title = "Top 10 GO Terms by Fold Enrichment",
       x = "GO Term",
       y = "Fold Enrichment") +
  theme_minimal()
...
ggplot(top_go_terms, aes(x = reorder(GO.biological.process.complete, upload_1..fold.Enrichment.), y = upload_1..fold.Enrichment.)) +
  geom_bar(stat = "identity", fill = "steelblue") +
  coord_flip() +
  labs(title = "Top 10 GO Terms by Fold Enrichment",
       x = "GO Term",
