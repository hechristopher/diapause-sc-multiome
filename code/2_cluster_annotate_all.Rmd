...
saveRDS(so_predia, paste0(outs_dir, "so_predia.rds"))
saveRDS(so_dev, paste0(outs_dir, "so_dev.rds"))
saveRDS(so_earlydia, paste0(outs_dir, "so_earlydia.rds"))
saveRDS(so_latedia, paste0(outs_dir, "so_latedia.rds"))
```
