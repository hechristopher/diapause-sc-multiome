...
subsampled_barcodes$prediction_encoded2 <- prediction_encoded2_full
...
translate(names(coefs[2:20]))

VlnPlot(so, features = names(coefs[2:20]), group.by = "timepoint_group")
```
